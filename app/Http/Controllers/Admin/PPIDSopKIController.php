...
class PPIDSopKIController extends Controller
{
    public function index()
    {
        $data = RegulasiSopKI::latest()->get();
        return view('pages.backend.informasi-publik.ppid.regulasi-sop-ki.index', compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = RegulasiSopKI::findOrFail($id);
