...
class PPIDRegulasiKIPController extends Controller
{
        /**
     * Display listing
     */
    public function index()
    {
        ...
        return view('pages.backend.informasi-publik.ppid.regulasi-kip.index', compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = RegulasiKIP::findOrFail($id);
